...
async function main() {
    ...
    while (condition) {
        const { enterParagraph } = await inquirer.prompt([{
                name: "enterParagraph",
                type: "input",
                message: gradient.instagram("Please enter the paragraph you want to count words of!")
            }]);
        let again = [{
                name: "tryAgain",
                type: "confirm",
        ...
        console.log(gradient.summer(`The number of words in this paragraph is ${words.length}`));
